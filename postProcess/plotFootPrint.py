...
radial footprint evolution for different cutoff radii. Outputs vector PDF and
high-resolution PNG files suitable for scientific publications.

Typical usage from the repository root:

    python3 postProcess/plotFootPrint.py
...
def main() -> None:
    ...
    if args.output:
        ...
        output_path = os.path.join(results_dir, "footprint_evolution")
